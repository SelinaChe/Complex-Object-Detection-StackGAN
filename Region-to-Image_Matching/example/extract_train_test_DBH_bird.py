...
if mynet== "finetuned":
    deploy= "/root/py-faster-rcnn/caffe-fast-rcnn/examples/cvprw15-imagenet-3/KevinNet_cifar10.prototxt"
    model= "/root/py-faster-rcnn/caffe-fast-rcnn/examples/cvprw15-imagenet-3/KevinNet_CIFAR10_128.caffemodel"

#    deploy= "/root/selectivesearch/example/cache_iccv_cub200/cnn_finetuning/caffe_reference/deploy_cub200.prototxt"
#    model= "/root/selectivesearch/example/cache_iccv_cub200/cnn_finetuning/caffe_reference/model_ft_iter_10000.caffemodel"
elif mynet== "caffenet":
